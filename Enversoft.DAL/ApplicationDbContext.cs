    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Logistics>(entity =>
            {
                ...
                entity.HasOne(d => d.WarehouseDelivery).WithMany(p => p.LogisticsWarehouseDelivery)
                    .HasForeignKey(d => d.WarehouseDeliveryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Logistics__Wareh__412EB0B6");

                entity.HasOne(d => d.WarehouseFrom).WithMany(p => p.LogisticsWarehouseFrom)
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                ...
                entity.HasOne(d => d.Item).WithMany(p => p.OrderItem)
            ...
            modelBuilder.Entity<SupplierLocation>(entity =>
            {
                ...
                entity.HasOne(d => d.Supplier).WithMany(p => p.SupplierLocation)
                    .HasForeignKey(d => d.SupplierId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
